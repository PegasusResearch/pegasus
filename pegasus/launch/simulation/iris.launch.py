...
def generate_launch_description():
    ...
    mavlink_forward_arg = DeclareLaunchArgument('mavlink_forward', default_value="['serial:///dev/ttyUSB0:460800']", description='A list of ips where to forward mavlink messages')
