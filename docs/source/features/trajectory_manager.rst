...
2. The desired acceleration to be tracked in the inertial frame is given by
   ...
   .. math:: 
      ...
      \ddot{p}_d(\gamma) &=\frac{d}{dt} \left(\frac{\partial p_d(\gamma)}{\partial \gamma}\dot{\gamma}\right) \\
                         ...
                         &= \frac{\partial p_d^2(\gamma)}{\partial \gamma^2}\dot{\gamma}^2 + \frac{\partial p_d(\gamma)}{\partial \gamma} \ddot{\gamma}
...
3. The desired jerk to be tracked in the inertial frame is given by
   ...
   .. math:: 
      ...
      \dddot{p}_d(\gamma) &= \frac{d}{dt}\left(\frac{\partial p_d^2(\gamma)}{\partial \gamma^2}\dot{\gamma}^2 + \frac{\partial p_d(\gamma)}{\partial \gamma} \ddot{\gamma}\right) \\
                          &=  \frac{d}{dt}\left(\frac{\partial p_d^2(\gamma)}{\partial \gamma^2}\dot{\gamma}^2\right) + \frac{d}{dt}\left(\frac{\partial p_d(\gamma)}{\partial \gamma} \ddot{\gamma}\right) \\
                          &= \frac{\partial p_d^3(\gamma)}{\partial \gamma^3}\dot{\gamma}^3 + 2\frac{\partial p_d^2(\gamma)}{\partial \gamma^2}\dot{\gamma}\ddot{\gamma} + 
                          \frac{\partial p_d^2(\gamma)}{\partial \gamma^2} \dot{\gamma}\ddot{\gamma} + \frac{\partial p_d(\gamma)}{\partial \gamma} \dddot{\gamma} \\
                          &= \frac{\partial p_d^3(\gamma)}{\partial \gamma^3}\dot{\gamma}^3 + 3\frac{\partial p_d^2(\gamma)}{\partial \gamma^2}\dot{\gamma}\ddot{\gamma} + \frac{\partial p_d(\gamma)}{\partial \gamma} \dddot{\gamma}
