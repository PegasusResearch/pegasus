...
def generate_launch_description():
    ...
    mav_connection_arg = DeclareLaunchArgument('connection', default_value='udp://:15006', description='The interface used to connect to the vehicle')
    ...
    drone_params_file_arg = DeclareLaunchArgument(
        'drone_params', 
        default_value=os.path.join(get_package_share_directory('pegasus_bringup'), 'config', 'snapdragon6.yaml'),
