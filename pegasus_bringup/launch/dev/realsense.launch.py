...
configurable_parameters = [{'name': 'vehicle_id',                   'default': '1', 'description': 'Drone ID in the network'},
                           {'name': 'vehicle_ns',                   'default': 'drone', 'description': 'Namespace to append to every topic and node name'},
                           ...
                           {'name': 'gyro_fps',                     'default': '60', 'description': "''"},                           
                           {'name': 'accel_fps',                    'default': '60', 'description': "''"},                           
                           ...
                           {'name': 'pose_fps',                     'default': '60', 'description': "''"},                           
